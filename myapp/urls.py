...
from myapp.views import ProductDelete, ProductDetailView, ProductListView, ProductUpdateView, index,new_one,products,product_details,add_product,update_product,delete_product
app_name = 'myapp'
urlpatterns = [
    path('',index),
    path('new/',new_one),
